...
HD_PWD='/home/leandro/Desktop/UBA/CESE/mys/tp_final/ip_repo/float_adder_ip/ip_repo/edit_float_adder_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_adder_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_adder_ip_v1_0.tcl
